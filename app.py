...
st.set_page_config(page_title="Clinical Intake Chatbot", page_icon="💬", layout="centered")
...
st.caption("Step 1: Basic details → Step 2: Chat-style questions → Summary")
st.markdown('<span class="mode-pill">Details → Q&A → Summary</span>', unsafe_allow_html=True)
...
Requirements:
- Output a concise list of 12–20 general questions that are broadly applicable and safe.
...
Task: Generate 5–10 PROBLEM-SPECIFIC questions based on the user's presenting concern.
...
with tab_intake:
    # Stage switcher: details page → Q&A page
    if ctx.get("ui_stage") == "details":
        ...
        with st.form("details_form"):
            ...
            submitted_details = st.form_submit_button("Continue to questions →")
